...
class CirculationControllerGalleries extends JControllerAdmin
{
	public function getModel($name = 'Gallery', $prefix = 'CirculationModel', $config = array('ignore_request' => true))
	{
